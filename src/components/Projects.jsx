...
function Projects() {
  ...
  },
  {
    ...
    github: "https://github.com/joaquinboto/Portfolio-Desarrollo-Web",
    deploy: "https://joaquinboto.github.io/Portfolio-Desarrollo-Web/",
    p: "Primer projecto, hecho con HTML & SASS"
  },
  {
    img: countries,
        ...
        {projectos.map((image) =>{
          return (
            <motion.div className='card' key={image}>
              ...
              <a target="_blank" href={image.deploy}>
